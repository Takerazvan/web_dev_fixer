...
public class JwtService {
    ...
    private final String secretKey = "5e19bc3554c781c53d4b8433ceb8b33fe2dba6e5fb06b8ef7f37d599467ab758";
    private final long exp = 1000 * 60 * 24;
    ...
    public String generateRefreshToken(
        ...
        return buildToken(new HashMap<>(), userDetails, exp);
    }
    ...
    public String generateTokenOauth(String name) {
